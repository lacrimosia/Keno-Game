...
// params - start, end, selector
keno.game.prototype.Values = function(a,b,c) {
  ...
  for (var m = a; m < b; m++) {
    ...
    //  console.log("j", j);
    $(c).append('<div class="nums ' + this.kenoNum[j] + '" id="' + this.kenoNum[j] + '" name="box">' + this.kenoNum[j] + '</div>');
